...
export default function GiftShop() {
  ...
  const { cartItems, totalItems, totalCents, addItem, removeItem, updateQuantity, clearCart } = useShopCart();
    ...
    <div style={{ color: 'white', minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '24px' }}>Gift Shop</h1>
        </div>
      ...
      <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
        <p style={{ color: 'var(--color-text-muted)', textAlign: 'center', marginBottom: '30px' }}>
          Browse our catalogue of zoo-themed souvenirs, plush animals, and take-home trinkets!
        </p>
        ...
        <div style={{
          ...
          {items.map(item => (
            <div key={item.item_id} className="glass-panel" style={{
              ...
              <div style={{ padding: '16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--color-text-muted)', fontSize: '13px', margin: '0 0 12px', flex: 1 }}>
                  {item.description}
                </p>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button onClick={() => { addItem(item); setCartOpen(true); }} className="glass-button" style={{
                ...
                {item.stock_quantity != null && item.stock_quantity <= 5 && item.stock_quantity > 0 && (
                  <p style={{ fontSize: '11px', color: '#f59e0b', margin: '8px 0 0' }}>
